...
public class ArtificialNeuralNet {
	 ...
	 * @param expected
	 */
	private static void Neuron(int x1, int x2, int expected) {
	...
	/**
	 * This is where all weights and bias are adjusted to teach XOR.
	 */
	private static void training(int x1, int x2) {
